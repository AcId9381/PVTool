...
/**
 ** \file C:\PVTool\src\wctl/wctl.parser.hh
 ** Define the PVTool::WCTL::parser class.
 */

// C++ LALR(1) parser skeleton written by Akim Demaille.

#ifndef YY_YY_C_PVTOOL_SRC_WCTL_WCTL_PARSER_HH_INCLUDED
# define YY_YY_C_PVTOOL_SRC_WCTL_WCTL_PARSER_HH_INCLUDED
// //                    "%code requires" blocks.
#line 11 "C:\\PVTool\\src\\wctl\\wctl.y" // lalr1.cc:377
...
#line 57 "C:\\PVTool\\src\\wctl/wctl.parser.hh" // lalr1.cc:377
...
#line 4 "C:\\PVTool\\src\\wctl\\wctl.y" // lalr1.cc:377
namespace PVTool { namespace WCTL {
#line 134 "C:\\PVTool\\src\\wctl/wctl.parser.hh" // lalr1.cc:377
  ...
  public:
    ...
    {
      // pformula
      char dummy1[sizeof(PathFormula*)];

      // sformula
      char dummy2[sizeof(StateFormula*)];
  ...
  basic_symbol (typename Base::kind_type t, const PathFormula* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const StateFormula* v, const location_type& l);
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    Parser (PVTool::WCTL::Scanner &scanner_yyarg, PVTool::WCTL::Driver &driver_yyarg);
    virtual ~Parser ();
    ...
    , location (other.location)
  {
    ...
    {
      case 23: // pformula
        value.copy< PathFormula* > (other.value);
        break;

      case 22: // sformula
        value.copy< StateFormula* > (other.value);
        break;
    ...
    , location (l)
  {
    ...
    {
      case 23: // pformula
        value.copy< PathFormula* > (v);
        break;

      case 22: // sformula
        value.copy< StateFormula* > (v);
        break;
  ...
  template <typename Base>
  Parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const PathFormula* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  Parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const StateFormula* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  Parser::basic_symbol<Base>::clear ()
  {
   ...
   default:
    ...
    {
      case 23: // pformula
        value.template destroy< PathFormula* > ();
        break;

      case 22: // sformula
        value.template destroy< StateFormula* > ();
        break;
  ...
  Parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    {
      case 23: // pformula
        value.move< PathFormula* > (s.value);
        break;

      case 22: // sformula
        value.move< StateFormula* > (s.value);
        break;
  ...
  Parser::symbol_type
  Parser::make_NEXT (const location_type& l)
  {
    return symbol_type (token::NEXT, l);
  }
...
#line 1181 "C:\\PVTool\\src\\wctl/wctl.parser.hh" // lalr1.cc:377




#endif // !YY_YY_C_PVTOOL_SRC_WCTL_WCTL_PARSER_HH_INCLUDED
